...
const initialState: AccountMainData[] = JSON.parse(localStorage.getItem("h") ?? "[]") as AccountMainData[]
...
export const { appendSeenAccountMainData, removeSeenAccountMainData, clearAllHistory } = historySlice.actions
...
// Selector 
export const selectHistory = (state: any) => state.history as AccountMainData[]
