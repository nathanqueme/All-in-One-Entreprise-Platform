 ...
 */
export type LoadingFailureType =
...
export let informationsMetada: InformationMetada[] = [
  ...
  new InformationMetada("country", localization.country, localization.select),
  ...
  new InformationMetada('translation', localization.translation, localization.select), 
  new InformationMetada('url', localization.url, localization.url), 
]
...
export function getInfoMetada(infoType: InformationType) {
  ...
  return infoMetada ?? new InformationMetada("name", localization.name, localization.name)
}
...
export type DailyTimetableSource =
  'RelatedItemPage' |
  'AccountInfoPage' |
  'PdfInfoPage'
...
export type SettingsInfo = 'your_account' | 'your_qr_code' | 'about' | 'sign_out' |
...
export function getSettingsInfoDescription(settingsInfo: SettingsInfo) {
  switch (settingsInfo) {
    ...
    case 'your_account': return localization.your_information // Before was "your_information"
...
// Web version
/**
 * The id of the main parent div. 
 * Used to disable scrolling when the AccountManagerSheet or the ActionSheet is disabled.
 */
export type ParentDivId =
  "ProfilePageDiv" |
  "PostViewerDiv" |
  "QrPageDiv" |
  "SettingsPageDiv" |
...
// (LARGE DEVICES ONLY)
export type EditingStepType = "details" | "actions" | "upload"
export function getEditingStepDescription(step: EditingStepType) {
    switch (step) {
        case 'details': return localization.details
        case 'actions': return localization.actions
        case 'upload': return localization.item_upload
    }
}