...
import { DailyTimetableObj, DailyTimetable } from '../../Data'
import { getUserPreferredLocale } from './../../assets/LanguagesList'
import { getDailyTimetablesOfEachDay } from './../ui/TimetablesRelated'
...
export function getDailyTimetablesOfGivenDay(day: number, dailyTimetables: DailyTimetable[]): DailyTimetable[] {
  ...
  if (dailyTimetables === undefined) return undefined
  if (dailyTimetables.length < 7) return undefined
...
export function getDayName(day: number) {
  ...
  switch (day) {
    case 0: dayNumber = 21; break // The 31 of Novembre in 2021 was a Sunday 
...
export function checkIfIsInTimeInterval(dailyTimetable: DailyTimetable) {
  ...
  let type: TimeIntervalType = undefined
