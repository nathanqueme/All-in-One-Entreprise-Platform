...
import { getBase64, getFileName } from '../components/functions'
 ...
 * @param short_id the id of the account.
 * @param jwtToken 
 ...
 * 
*/
export async function generateAndUploadSearchPhoto(imageUri: string, short_id: string, jwtToken: string): Promise<string> {
    return new Promise(async (resolve, reject) => {
        ...
        // Step 2
        try {
            let file_name = getFileName("search_photo", short_id)
