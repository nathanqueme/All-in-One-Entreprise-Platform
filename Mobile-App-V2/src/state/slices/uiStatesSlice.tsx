...
export const uiStatesSlice = createSlice({
    ...
    reducers: {
        updateUiStateValue: (state, action) => {

            // Values 
            const { attribute, value } : updateUiStateValuePayload = action.payload
            
            // Updates 
            state[attribute as any] = value
...
// Selector 
export const selectUiStates = state => state.uiStates as UiStatesInterface