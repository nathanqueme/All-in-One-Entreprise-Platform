...
import { CategoryType, ImageType, AccountType, TemporaryTime, TimetablesType, SpecialTimeType, ProfileButtonType, ErrorType, ErrorDetail } from "./types"
...
// NEW
type SearchResultType = "accountMainData" | "city"
...
export function HashObj(iv: string, content: string) {
  return {
      iv: iv,
      content: content,
  }
